...
class DataSet():
    ...
    def __init__(self, seq_length=40, class_limit=None, image_shape=(224, 224, 3)):
        ...
        self.sequence_path = os.path.join('data_old', 'sequences')
    ...
    def get_data():
        ...
        with open(os.path.join('data_old', 'data_file.csv'), 'r') as fin:
    ...
    def get_trajectory(self, data_type, sample):
        """Get the saved extracted features."""
        filename = sample[2]
        path = os.path.join('data_old', 'photo', sample[0], sample[1], sample[2], 'inter.txt')
    ...
    def get_point(self, data_type, sample):
        """Get the saved extracted features."""
        filename = sample[2]
        path = os.path.join('data_old', 'photo', sample[0], sample[1], sample[2], 'inter_downsample.txt')
        txtdata = np.loadtxt(path)
        #print ('get_point')
        if os.path.isfile(path):
            return txtdata
    ...
    def get_frames_for_sample(sample):
        ...
        filenames."""
        path = os.path.join('data_old', 'photo', sample[0], sample[1], sample[2],'img')
        filename = sample[2]
